package com.example.ung_dung_nghe_nhac_don_gian.config;
...
@Configuration
@EnableWebMvc
@ComponentScan("com.example.ung_dung_nghe_nhac_don_gian")
...
public class AppConfiguration extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan(new String[]{"com.example.ung_dung_nghe_nhac_don_gian.model"});
